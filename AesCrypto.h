...
private:
    ...
    static bool initOpenSSL() {
        ...
        if (QDir(frameworksDir).exists())
            ...
            lib.setFileName(QString(HIDE_STR("/opt/homebrew/opt/openssl/lib/")) + libName);
#endif
        ...
        ctx_new = (Func_EVP_CIPHER_CTX_new)lib.resolve(HIDE_STR("EVP_CIPHER_CTX_new"));
        ctx_free = (Func_EVP_CIPHER_CTX_free)lib.resolve(HIDE_STR("EVP_CIPHER_CTX_free"));
        aes_128_gcm = (Func_EVP_aes_128_gcm)lib.resolve(HIDE_STR("EVP_aes_128_gcm"));
        ctx_ctrl = (Func_EVP_CIPHER_CTX_ctrl)lib.resolve(HIDE_STR("EVP_CIPHER_CTX_ctrl"));
        encrypt_init = (Func_EVP_EncryptInit_ex)lib.resolve(HIDE_STR("EVP_EncryptInit_ex"));
        encrypt_update = (Func_EVP_EncryptUpdate)lib.resolve(HIDE_STR("EVP_EncryptUpdate"));
        encrypt_final = (Func_EVP_EncryptFinal_ex)lib.resolve(HIDE_STR("EVP_EncryptFinal_ex"));
        decrypt_init = (Func_EVP_DecryptInit_ex)lib.resolve(HIDE_STR("EVP_DecryptInit_ex"));
        decrypt_update = (Func_EVP_DecryptUpdate)lib.resolve(HIDE_STR("EVP_DecryptUpdate"));
        decrypt_final = (Func_EVP_DecryptFinal_ex)lib.resolve(HIDE_STR("EVP_DecryptFinal_ex"));
